...
//**
//**  DESCRIPTION:  Lab4 is a follow on lab from Lab1 and demonstrate step
//**                start control over DC motors using FSM.  
//**
//*****************************************************************************
...
//@LT Dahlen:  This header file was borrowed for use from the Lab 1 exercise.
